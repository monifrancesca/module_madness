...
/*
 ...
 Finally, in the app.js, set up a server, write a 200 head, and write a message that combines the text return of the third module,
...
var finalNumber = require('./final-number');

// create the server
http.createServer(function (req, res) {
    res.writeHead(200); // send header msg "everything is ok"
    res.write(finalNumber.accountBalance() + finalNumber.combineFunctions());
    res.end();
}).listen(3000);
